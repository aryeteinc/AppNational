...
class Paypal_lib {
    ...
    function __construct()
    {
        ...
        //$this->add_field('add','1');
        //$this->add_field('display','1');
    ...
    function paypal_auto_form() 
    {
        ...
        $retornado .= '<html>' . "\n";
        $retornado .= '<head><title>Processing Payment...</title></head>' . "\n";
        $retornado .= '<body style="text-align:center;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
        $retornado .= '<p style="text-align:center;">Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
        $retornado .= $this->paypal_form('paypal_auto_form');
        $retornado .= '</body></html>';
        return $retornado;
    }
